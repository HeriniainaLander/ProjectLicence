                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Mettre à jour un Diffusion') }}</h3></div>
                            <div class="card-body">
                                <div class="form">
                                    <div class="form">
                                        <form class="cmxform form-horizontal tasi-form" id="signupForm" method="POST" action="{{ route('diffusions.update',$diffusion) }}" autocomplete="off" class="form-horizontal" novalidate>
                                            {{ csrf_field()}}
                                            {{ method_field('PUT') }}
                                            <div class="form-group row">
                                                <label for="input-title" class="col-form-label col-lg-2">{{ __('Titre *') }}</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control{{ $errors->has('libelle') ? ' is-invalid' : '' }}" type="text"  name="title" id="input-title" value="{{ old('title') ?? $diffusion->titre }}" required/>
                                                    @if ($errors->has('title'))
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control{{ $errors->has('debutDiff') ? ' is-invalid' : '' }}" name="debutDiff" id="input-debutDiff" type="date" value="{{ old('debutDiff') ?? $diffusion->debut_diffusion }}" required />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control{{ $errors->has('finDiff') ? ' is-invalid' : '' }}" name="finDiff" id="input-finDiff" type="date" value="{{ old('finDiff') ?? $diffusion->fin_diffusion }}" required />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control{{ $errors->has('heureDiff') ? ' is-invalid' : '' }}" name="heureDiff" id="input-heureDiff" type="text" value="{{ old('heureDiff') ?? $diffusion->heure_diffusion }}" required />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control{{ $errors->has('nbDiff') ? ' is-invalid' : '' }}" name="nbDiff" id="input-nbDiff" type="number" value="{{ old('nbDiff') ?? $diffusion->nb_diffusion }}" required />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control{{ $errors->has('quitance') ? ' is-invalid' : '' }}" name="quitance" id="input-finDiff" type="text" value="{{ old('quitance') ?? $diffusion->numQuitance }}" required />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <select class="form-control{{ $errors->has('client') ? ' is-invalid' : '' }}" type="text" id="input-client_id" name="client" required>
                                                        <option value="{{ $diffusion->client->id }}" selected>{{  $diffusion->client->nom }}</option>
                                                        @foreach($clients as $client)
                                                            @if($diffusion->client->id !== $client->id)
