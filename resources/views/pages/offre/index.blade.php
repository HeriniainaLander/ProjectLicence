                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Table Offre</h4>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Liste des Offres dispinibles</h3>
                            </div>
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    @foreach($offres as $offre)
                                        <tr>
                                            ...
                                            <td>{{ $offre->updated_at->diffForHumans() }}</td>
                                            <td>
                                                <div class="btn-group mb-2">
                                                    <a href="{{ route('offres.edit', $offre->id)  }}" class="btn btn-outline-secondary waves-effect btn-sm" rel="tooltip" title="modifier">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-outline-secondary waves-effect btn-sm delete" data-toggle="modal" data-url="{!! URL::route('offres.destroy', $offre->id) !!}"  data-name="{{ $offre->libelle }}" data-target="#card-modal" rel="tooltip" title="supprimer">
